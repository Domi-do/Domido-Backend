...
const guestDominoRouter = express.Router();

guestDominoRouter.get("/:projectId", async (req, res) => {
  try {
...
guestDominoRouter.post("/:projectId", async (req, res) => {
  try {
    const { projectId } = req.params;
...
guestDominoRouter.post("/:projectId/overwrite", async (req, res) => {
  try {
    const { projectId } = req.params;
    const { dominos } = req.body;
...
export default guestDominoRouter;
